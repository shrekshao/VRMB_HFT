...
Shader "Effect/Effect Blended Premultiply"
{
	Properties
	{
...
#endif
#ifdef Enable_Bloom
				fixed4 c = i.color * tex2D(_MainTex, i.uv_MainTex) * i.color.a * (exp(_EmissionGain * 5.0f));
#else
				fixed4 c = i.color * tex2D(_MainTex, i.uv_MainTex) * i.color.a;
#endif
#ifdef Enable_AlphaMask
